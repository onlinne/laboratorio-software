...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        \Session::flash('flash_message', 'Nuevo Usuario Ha Sido Creado!');
    ...
    public function update(Request $request, $user)
    {
        ...
        \Session::flash('flash_message', 'Usuario Modificado!');
        return redirect(route('user.edit',compact('submitbuttontext', 'user', 'roles')));
    }
